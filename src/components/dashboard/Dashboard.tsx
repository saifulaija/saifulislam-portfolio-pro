...
import { Menu, Bell, UserRoundPlus } from 'lucide-react';
...
export function Dashboard({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { label: "Projects", path: "/projects", show: !!user }, // Show only if user exists
    { label: "Blogs", path: "/blogs", show: !!user },      // Show only if user exists
